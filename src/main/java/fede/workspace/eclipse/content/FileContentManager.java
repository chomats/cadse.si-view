...
public class FileContentManager extends ContentItemImpl {
	...
	public void init() throws CadseException {
		IFile f = getFile(ContextVariableImpl.DEFAULT);
		if (f != null) {
	...
	public void delete() throws CadseException {
		...
		try {
			...
			throw new CadseException("Cannot create folder from {0} : {1}", e, getOwnerItem().getId(), e.getMessage());
		}
	}
	...
	public IFile getFile() {
		return getFile(ContextVariableImpl.DEFAULT);
	}
