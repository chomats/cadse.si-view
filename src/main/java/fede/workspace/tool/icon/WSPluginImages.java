 ...
 * under the License.
 */
package fede.workspace.tool.icon;
...
//		if (fgImageRegistry != null) {
//			WSPlugin.logErrorMessage("Image registry already defined"); //$NON-NLS-1$
//		}
//		return result;
//	}
	 ...
	 * or <code>null</code>.
	 */
	public static ImageDescriptor create(String prefix, String name, boolean useMissingImageDescriptor) {
		IPath path= ICONS_PATH.append(prefix).append(name);
		return createImageDescriptor(WSPlugin.getDefault().getBundle(), path, useMissingImageDescriptor);
	}
